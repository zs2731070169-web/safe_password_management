...
<template>
  <view class="pw-strength" :class="levelClass">
    <view class="pw-strength__head">
      <text class="pw-strength__label">密码强度</text>
      <text class="pw-strength__status">{{ strength.text }}</text>
    </view>
    <view class="pw-strength__track">
      <text
        v-for="i in SEGMENTS"
        :key="i"

...
<template>
  <view class="add-hero">
    <!-- 背景装饰方块网格（旋转 12°，低透明度） -->
    <view class="add-hero__deco" aria-hidden="true">
      <view v-for="i in 6" :key="i" class="add-hero__block"></view>
    </view>

    <!-- 中央内容 -->
    <view class="add-hero__content">
      <AppIcon
        name="shield-solid"
        :width="24"
        :height="30"
      ...
      />
      <text class="add-hero__tagline">密码管理小助手 · 安全加密</text>
    </view>
  </view>
</template>

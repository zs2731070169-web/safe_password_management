<script setup>
/**
 * SetupPasswordStep —— 新用户开户：创建云账户（uni-app 版）
 *
...
<template>
  <view class="setup-step">
    ...
    <view class="setup-status">
      <view class="setup-status__badge">
        <AppIcon name="shield-solid" :width="26" :height="33" :color="'#ffffff'" />
      </view>
      <text class="setup-status__title">创建云账户</text>
      <text class="setup-status__desc">
    ...
    <button
      ...
      @click="handleSubmit"
    >
      <text>{{ authenticating ? '创建中…' : '创建账户' }}</text>

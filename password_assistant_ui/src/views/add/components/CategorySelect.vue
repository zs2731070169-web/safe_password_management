<script setup>
/**
 * CategorySelect —— 分类选择字段（chips 标签式）
 *
 ...
 * 真正的「创建分类」在表单保存时由父级解析处理（见 AddPasswordView）。
 */
...
<template>
  <div class="cat-field">
    <label class="cat-field__label">分类</label>

    <!-- 标签选择区：点选既有分类，或点「+ 新建」 -->
    <div v-if="!creating" class="cat-field__chips">
      <button
    ...
    <!-- 新建输入态：显式输入新分类名 -->
    <div v-else class="cat-field__create">
      <input
        ref="inputRef"

...
<template>
  <Teleport to="body">
    <Transition name="confirm-sheet">
      <div v-if="modelValue" class="confirm-sheet" @click.self="close">
        <div
        ...
        >
          <div class="confirm-sheet__body">
            ...
            <p v-if="message" class="confirm-sheet__message">{{ message }}</p>
          </div>
...
.confirm-sheet-enter-active .confirm-sheet__panel,
.confirm-sheet-leave-active .confirm-sheet__panel {
...
.confirm-sheet-enter-from .confirm-sheet__panel,
.confirm-sheet-leave-to .confirm-sheet__panel {
